    ...
    for row in spamreader:
        ...
        try:
            ...
            if row[1] == 'salida':
                ...
                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-lisboa/':
                    row[0] = 'Lisbon'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-berlin-brandeburgo-willy-brandt/':
                    row[0] = 'Berlin'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-berlin-tegel/':
                    row[0] = 'Berlin'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-berlin-schonefeld/':
                    row[0] = 'Berlin'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-karlsruhe-baden-baden/':
                    row[0] = 'Baden-Baden'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-friedrichshafen/':
                    row[0] = 'Friedrichshafen'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-la-ciudad-de-mannheim/':
                    row[0] = 'Mannheim'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-stuttgart/':
                    row[0] = 'Stuttgart'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-bremen/':
                    row[0] = 'Bremen'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-bremerhaven/':
                    row[0] = 'Luneort'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-colonia-bonn/':
                    row[0] = 'Cologne'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-dortmund/':
                    row[0] = 'Dortmund'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-internacional-de-dusseldorf/':
                    row[0] = 'Dusseldorf'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-weeze/':
                    row[0] = 'Weeze'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-munster-osnabruck/':
                    row[0] = 'Greven'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-paderborn-lippstadt/':
                    row[0] = 'Büren'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-dresde/':
                    row[0] = 'Dresde'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-erfurt/':
                    row[0] = 'Erfurt'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-leipzig-halle/':
                    row[0] = 'Leipzig'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-leipzig-altenburg/':
                    row[0] = 'Leipzig'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-frankfurt/':
                    row[0] = 'Frankfurt'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-hamburgo-fuhlsbuttel/':
                    row[0] = 'Hamburg'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-hanover/':
                    row[0] = 'Hannover'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-frankfurt-hahn/':
                    row[0] = 'Frankfurt'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-lubeck/':
                    row[0] = 'Lubeck'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-sylt/':
                    row[0] = 'Sylt'

                if row[0] == 'https://www.aeropuertos.net/aeropuertos-en-memmingen/':
                    row[0] = 'Memmingen'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-munich/':
                    row[0] = 'Munich'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-nuremberg/':
                    row[0] = 'Nuremberg'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-rostock-laage/':
                    row[0] = 'Rostock'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-saarbrucken/':
                    row[0] = 'Saarbrucken'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-bruselas/':
                    row[0] = 'Brussels'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-bruselas-sur/':
                    row[0] = 'Brussels'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-amberes-deurne/':
                    row[0] = 'Amberes'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-lieja/':
                    row[0] = 'Lieja'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-sofia/':
                    row[0] = 'Sofia'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-copenhague-kastrup/':
                    row[0] = 'Copenhagen'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-madrid/':
                    row[0] = 'Madrid'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-madrid-cuatro-vientos-mcv/':
                    row[0] = 'Madrid'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-albacete/':
                    row[0] = 'Albacete'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-alicante/':
                    row[0] = 'Alicante'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-almeria/':
                    row[0] = 'Almeria'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-asturias/':
                    row[0] = 'Asturias'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-badajoz/':
                    row[0] = 'Badajoz'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-barcelona/':
                    row[0] = 'Barcelona'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-bilbao/':
                    row[0] = 'Bilbao'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-burgos/':
                    row[0] = 'Burgos'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-central-de-ciudad-real/':
                    row[0] = 'CiudadReal'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-cordoba/':
                    row[0] = 'Cordoba'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-el-hierro/':
                    row[0] = 'ElHierro'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-fuerteventura/':
                    row[0] = 'Fuerteventura'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-gran-canaria/':
                    row[0] = 'GranCanaria'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-gerona-costa-brava/':
                    row[0] = 'Gerona'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-granada/':
                    row[0] = 'Granada'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-huesca-pirineos/':
                    row[0] = 'Huesca'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-ibiza/':
                    row[0] = 'Ibiza'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-jerez/':
                    row[0] = 'Jerez'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-la-coruna/':
                    row[0] = 'LaCoruña'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-la-gomera/':
                    row[0] = 'LaGomera'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-la-palma/':
                    row[0] = 'LaPalma'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-lanzarote/':
                    row[0] = 'Lanzarote'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-leon/':
                    row[0] = 'Leon'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-logrono-agoncillo/':
                    row[0] = 'Logroño'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-madrid-torrejon/':
                    row[0] = 'Madrid'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-menorca/':
                    row[0] = 'Menorca'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-malaga/':
                    row[0] = 'Malaga'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-melilla/':
                    row[0] = 'Melilla'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-murcia-san-javier/':
                    row[0] = 'Murcia'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-palma-de-mallorca/':
                    row[0] = 'PalmaMallorca'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-pamplona/':
                    row[0] = 'Pamplona'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-reus/':
                    row[0] = 'Reus'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-sabadell/':
                    row[0] = 'Sabadell'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-san-sebastian/':
                    row[0] = 'SanSebastian'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-santiago-de-compostela/':
                    row[0] = 'SantiagodeCompostela'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-salamanca/':
                    row[0] = 'Salamanca'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-santander/':
                    row[0] = 'Santander'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-sevilla/':
                    row[0] = 'Sevilla'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-tenerife-norte/':
                    row[0] = 'Tenerife'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-tenerife-sur/':
                    row[0] = 'Tenerife'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-valencia/':
                    row[0] = 'Valencia'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-valladolid/':
                    row[0] = 'Valladolid'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-vigo/':
                    row[0] = 'Vigo'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-vitoria/':
                    row[0] = 'Vitoria'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-zaragoza/':
                    row[0] = 'Zaragoza'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-paris-charles-de-gaulle/':
                    row[0] = 'Paris'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-paris-orly/':
                    row[0] = 'Paris'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-beauvais-tille/':
                    row[0] = 'Beauvais'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-biarritz-anglet-bayonne/':
                    row[0] = 'Biarritz'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-burdeos-merignac/':
                    row[0] = 'Burdeos'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-internacional-de-pau-pirineos/':
                    row[0] = 'Pau'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-internacional-de-estrasburgo/':
                    row[0] = 'Estrasburg'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-basilea-mulhouse-friburgo/':
                    row[0] = 'Basel, Switzerland/Mulhouse'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-internacional-de-lyon-saint-exupery/':
                    row[0] = 'Lyon'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-saint-etienne-boutheon/':
                    row[0] = 'SaintEtienne'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-marsella-provenza/':
                    row[0] = 'Marseille'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-niza-costa-azul/':
                    row[0] = 'Niza'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-montpellier-mediterranee/':
                    row[0] = 'Montpellier'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-toulouse-blagnac/':
                    row[0] = 'Toulouse'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-helsinki-vantaa/':
                    row[0] = 'Helsinki'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-internacional-eleftherios-venizelos/':
                    row[0] = 'Athens'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-amsterdam-schiphol/':
                    row[0] = 'Amsterdam'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-eindhoven/':
                    row[0] = 'Eindhoven'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-groningen-eelde/':
                    row[0] = 'Eelde'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-roterdam/':
                    row[0] = 'Rotterdam'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-budapest-ferenc-liszt/':
                    row[0] = 'Budapest'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-dublin/':
                    row[0] = 'Dublin'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-roma-fiumicino/':
                    row[0] = 'Rome'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-internacional-de-riga/':
                    row[0] = 'Riga'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-luxemburgo/':
                    row[0] = 'Luxemburgo'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-oslo-gardermoen/':
                    row[0] = 'Oslo'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-bergen-flesland/':
                    row[0] = 'Bergen'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-varsovia-frederic-chopin/':
                    row[0] = 'Varsovia'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-cracovia-juan-pablo-ii/':
                    row[0] = 'Cracovia'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-internacional-de-faro/':
                    row[0] = 'Faro'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-lajes/':
                    row[0] = 'Terceira'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-madeira/':
                    row[0] = 'Madeira'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-oporto-francisco-sa-carneiro/':
                    row[0] = 'Porto'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-juan-pablo-ii/':
                    row[0] = 'PontaDelgada'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-edimburgo/':
                    row[0] = 'Edinburgh'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-internacional-de-glasgow/':
                    row[0] = 'Glasgow'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-glasgow-prestwick/':
                    row[0] = 'Glasgow'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-la-ciudad-de-londres/':
                    row[0] = 'London'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-londres-gatwick/':
                    row[0] = 'London'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-londres-heathrow/':
                    row[0] = 'London'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-londres-luton/':
                    row[0] = 'London'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-londres-oxford/':
                    row[0] = 'London'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-londres-southend/':
                    row[0] = 'London'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-londres-stansted/':
                    row[0] = 'London'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-internacional-de-birmingham/':
                    row[0] = 'Birmingham'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-internacional-de-bristol/':
                    row[0] = 'Bristol'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-internacional-de-liverpool/':
                    row[0] = 'Liverpool'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-manchester/':
                    row[0] = 'Manchester'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-internacional-de-newcastle/':
                    row[0] = 'Newcastle'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-gibraltar/':
                    row[0] = 'Gibraltar'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-internacional-owen-roberts/':
                    row[0] = 'GeorgeTown'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-praga/':
                    row[0] = 'Praga'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-internacional-de-bucarest-henri-coanda/':
                    row[0] = 'Bucarest'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-estocolmo-arlanda/':
                    row[0] = 'Stockholm'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-estocolmo-skavsta/':
                    row[0] = 'Stockholm'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-estocolmo-bromma/':
                    row[0] = 'Stockholm'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-estocolmo-vasteras/':
                    row[0] = 'Stockholm'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-berna/':
                    row[0] = 'Berna'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-zurich/':
                    row[0] = 'Zurich'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-internacional-de-ginebra/':
                    row[0] = 'Ginebra'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-internacional-ataturk/':
                    row[0] = 'Istanbul'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-verona-villafranca/':
                    row[0] = 'Verona'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-venecia/':
                    row[0] = 'Venice'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-internacional-galileo-galilei/':
                    row[0] = 'Pisa'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-turin-caselle/':
                    row[0] = 'Turin'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-perugia/':
                    row[0] = 'Asis'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-catania-fontanarossa/':
                    row[0] = 'Catania'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-palermo-punta-raisi/':
                    row[0] = 'Palermo'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-forli/':
                    row[0] = 'Forli'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-bolonia/':
                    row[0] = 'Bologna'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-rimini/':
                    row[0] = 'Miramare'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-parma-giuseppe-verdi/':
                    row[0] = 'Parma'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-napoles-capodichino/':
                    row[0] = 'Naples'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-genova/':
                    row[0] = 'Genoa'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-florencia/':
                    row[0] = 'Florence'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-reggio-di-calabria/':
                    row[0] = 'ReggioCalabria'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-bari-palese/':
                    row[0] = 'Bari'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-milan-linate/':
                    row[0] = 'Milan'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-brescia/':
                    row[0] = 'Montichiari'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-bergamo-orio-al-serio/':
                    row[0] = 'Bergamo'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-cagliari-elmas/':
                    row[0] = 'Cagliari'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-alghero-fertilia/':
                    row[0] = 'Alghero'

                if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-ancona-falconara/':
                    row[0] = 'Ancona'
        ...
        try:
            ...
            if row[1] == 'salida':
                if row[0] != 'aeropuerto':
                    ...
                    if row[0] =='https://www.aeropuertos.net/aeropuerto-de-karlsruhe-baden-baden/':
                        nodes.append('Baden-Baden')
                        europa.append('Baden-Baden')

                    if row[0] =='https://www.aeropuertos.net/aeropuerto-de-friedrichshafen/':
                        nodes.append('Friedrichshafen')
                        europa.append('Friedrichshafen')

                    if row[0] =='https://www.aeropuertos.net/aeropuerto-de-la-ciudad-de-mannheim/':
                        nodes.append('Mannheim')
                        europa.append('Mannheim')

                    if row[0] =='https://www.aeropuertos.net/aeropuerto-de-stuttgart/':
                        nodes.append('Stuttgart')
                        europa.append('Stuttgart')

                    if row[0] =='https://www.aeropuertos.net/aeropuerto-de-bremen/':
                        nodes.append('Bremen')
                        europa.append('Bremen')

                    if row[0] =='https://www.aeropuertos.net/aeropuerto-de-bremerhaven/':
                        nodes.append('Luneort')
                        europa.append('Luneort')

                    if row[0] =='https://www.aeropuertos.net/aeropuerto-de-colonia-bonn/':
                        nodes.append('Cologne')
                        europa.append('Cologne')

                    if row[0] =='https://www.aeropuertos.net/aeropuerto-de-dortmund/':
                        nodes.append('Dortmund')
                        europa.append('Dortmund')

                    if row[0] =='https://www.aeropuertos.net/aeropuerto-internacional-de-dusseldorf/':
                        nodes.append('Dusseldorf')
                        europa.append('Dusseldorf')
                    ...
                    if row[0] =='https://www.aeropuertos.net/aeropuerto-de-dresde/':
                        nodes.append('Dresde')
                        europa.append('Dresde')

                    if row[0] =='https://www.aeropuertos.net/aeropuerto-de-erfurt/':
                        nodes.append('Erfurt')
                        europa.append('Erfurt')

                    if row[0] =='https://www.aeropuertos.net/aeropuerto-de-leipzig-halle/':
                        nodes.append('Leipzig')
                        europa.append('Leipzig')
                    ...
                    if row[0] =='https://www.aeropuertos.net/aeropuerto-de-frankfurt/':
                        nodes.append('Frankfurt')
                        europa.append('Frankfurt')

                    if row[0] =='https://www.aeropuertos.net/aeropuerto-de-hamburgo-fuhlsbuttel/':
                        nodes.append('Hamburg')
                        europa.append('Hamburg')

                    if row[0] =='https://www.aeropuertos.net/aeropuerto-de-hanover/':
                        nodes.append('Hannover')
                        europa.append('Hannover')
                    ...
                    if row[0] =='https://www.aeropuertos.net/aeropuertos-en-memmingen/':
                        nodes.append('Memmingen')
                        europa.append('Memmingen')

                    if row[0] =='https://www.aeropuertos.net/aeropuerto-de-munich/':
                        nodes.append('Munich')
                        europa.append('Munich')

                    if row[0] =='https://www.aeropuertos.net/aeropuerto-de-nuremberg/':
                        nodes.append('Nuremberg')
                        europa.append('Nuremberg')

                    if row[0] =='https://www.aeropuertos.net/aeropuerto-de-rostock-laage/':
                        nodes.append('Rostock')
                        europa.append('Rostock')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-saarbrucken/':
                        nodes.append('Saarbrucken')
                        europa.append('Saarbrucken')

                    if row[0] =='https://www.aeropuertos.net/aeropuerto-de-bruselas/':
                        nodes.append('Brussels')
                        europa.append('Brussels')
                    ...
                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-amberes-deurne/':
                        nodes.append('Antwerp')
                        europa.append('Antwerp')
                    ...
                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-copenhague-kastrup/':
                        ...
                        europa.append('Copenhagen')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-madrid/':
                        nodes.append('Madrid')
                        europa.append('Madrid')
                    ...
                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-albacete/':
                        nodes.append('Albacete')
                        europa.append('Albacete')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-alicante/':
                        nodes.append('Alicante')
                        europa.append('Alicante')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-almeria/':
                        nodes.append('Almeria')
                        europa.append('Almeria')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-asturias/':
                        nodes.append('Asturias')
                        europa.append('Asturias')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-badajoz/':
                        nodes.append('Badajoz')
                        europa.append('Badajoz')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-barcelona/':
                        nodes.append('Barcelona')
                        europa.append('Barcelona')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-bilbao/':
                        nodes.append('Bilbao')
                        europa.append('Bilbao')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-burgos/':
                        nodes.append('Burgos')
                        europa.append('Burgos')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-central-de-ciudad-real/':
                        nodes.append('CiudadReal')
                        europa.append('CiudadReal')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-cordoba/':
                        nodes.append('Cordoba')
                        europa.append('Cordoba')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-el-hierro/':
                        nodes.append('ElHierro')
                        europa.append('ElHierro')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-fuerteventura/':
                        nodes.append('Fuerteventura')
                        europa.append('Fuerteventura')

                    if row[0] =='https://www.aeropuertos.net/aeropuerto-de-gran-canaria/':
                        nodes.append('GranCanaria')
                        europa.append('GranCanaria')


                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-gerona-costa-brava/':
                        nodes.append('Gerona')
                        europa.append('Gerona')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-granada/':
                        nodes.append('Granada')
                        europa.append('Granada')


                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-huesca-pirineos/':
                        nodes.append('Huesca')
                        europa.append('Huesca')
                    ...
                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-la-coruna/':
                        nodes.append('LaCoruña')
                        europa.append('LaCoruña')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-la-gomera/':
                        nodes.append('LaGomera')
                        europa.append('LaGomera')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-la-palma/':
                        nodes.append('LaPalma')
                        europa.append('LaPalma')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-lanzarote/':
                        nodes.append('Lanzarote')
                        europa.append('Lanzarote')
                    ...
                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-logrono-agoncillo/':
                        nodes.append('Logroño')
                        europa.append('Logroño')
                    ...
                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-menorca/':
                        nodes.append('Menorca')
                        europa.append('Menorca')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-malaga/':
                        nodes.append('Malaga')
                        europa.append('Malaga')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-melilla/':
                        nodes.append('Melilla')
                        europa.append('Melilla')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-murcia-san-javier/':
                        nodes.append('Murcia')
                        europa.append('Murcia')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-palma-de-mallorca/':
                        nodes.append('PalmaMallorca')
                        europa.append('PalmaMallorca')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-pamplona/':
                        nodes.append('Pamplona')
                        europa.append('Pamplona')
                    ...
                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-sabadell/':
                        nodes.append('Sabadell')
                        europa.append('Sabadell')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-san-sebastian/':
                        nodes.append('SanSebastian')
                        europa.append('SanSebastian')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-santiago-de-compostela/':
                        nodes.append('SantiagodeCompostela')
                        europa.append('SantiagodeCompostela')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-salamanca/':
                        nodes.append('Salamanca')
                        europa.append('Salamanca')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-santander/':
                        nodes.append('Santander')
                        europa.append('Santander')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-sevilla/':
                        nodes.append('Sevilla')
                        europa.append('Sevilla')

                    if row[0] =='https://www.aeropuertos.net/aeropuerto-de-tenerife-norte/':
                        nodes.append('Tenerife')
                        europa.append('Tenerife')
                    ...
                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-valencia/':
                        nodes.append('Valencia')
                        europa.append('Valencia')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-valladolid/':
                        nodes.append('Valladolid')
                        europa.append('Valladolid')
                    ...
                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-vitoria/':
                        nodes.append('Vitoria')
                        europa.append('Vitoria')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-zaragoza/':
                        nodes.append('Zaragoza')
                        europa.append('Zaragoza')
                    ...
                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-beauvais-tille/':
                        nodes.append('Beauvais')
                        europa.append('Beauvais')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-biarritz-anglet-bayonne/':
                        nodes.append('Biarritz')
                        europa.append('Biarritz')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-burdeos-merignac/':
                        nodes.append('Burdeaux')
                        europa.append('Burdeaux')
                    ...
                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-internacional-de-estrasburgo/':
                        nodes.append('Strasbourg')
                        europa.append('Strasbourg')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-basilea-mulhouse-friburgo/':
                        nodes.append('Basel, Switzerland/Mulhouse')
                        europa.append('Basel, Switzerland/Mulhouse')
                    ...
                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-saint-etienne-boutheon/':
                        nodes.append('SaintEtienne')
                        europa.append('SaintEtienne')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-marsella-provenza/':
                        nodes.append('Marseille')
                        europa.append('Marseille')
                    ...
                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-montpellier-mediterranee/':
                        nodes.append('Montpellier')
                        europa.append('Montpellier')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-toulouse-blagnac/':
                        nodes.append('Toulouse')
                        europa.append('Toulouse')


                    if row[0] =='https://www.aeropuertos.net/aeropuerto-de-helsinki-vantaa/':
                        nodes.append('Helsinki')
                        europa.append('Helsinki')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-internacional-eleftherios-venizelos/':
                        nodes.append('Athens')
                        europa.append('Athens')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-amsterdam-schiphol/':
                        nodes.append('Amsterdam')
                        europa.append('Amsterdam')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-eindhoven/':
                        nodes.append('Eindhoven')
                        europa.append('Eindhoven')
                    ...
                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-roterdam/':
                        nodes.append('Rotterdam')
                        europa.append('Rotterdam')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-budapest-ferenc-liszt/':
                        nodes.append('Budapest')
                        europa.append('Budapest')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-dublin/':
                        nodes.append('Dublin')
                        europa.append('Dublin')
                    ...
                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-bergen-flesland/':
                        nodes.append('Bergen')
                        europa.append('Bergen')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-varsovia-frederic-chopin/':
                        nodes.append('Varsovia')
                        europa.append('Varsovia')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-cracovia-juan-pablo-ii/':
                        nodes.append('Cracovia')
                        europa.append('Cracovia')
                    ...
                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-lajes/':
                        nodes.append('Terceira')
                        europa.append('Terceira')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-madeira/':
                        nodes.append('Madeira')
                        europa.append('Madeira')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-lisboa/':
                        nodes.append('Lisbon')
                        europa.append('Lisbon')
                    ...
                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-juan-pablo-ii/':
                        nodes.append('PontaDelgada')
                        europa.append('PontaDelgada')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-edimburgo/':
                        nodes.append('Edinburgh')
                        europa.append('Edinburgh')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-internacional-de-glasgow/':
                        nodes.append('Glasgow')
                        europa.append('Glasgow')
                    ...
                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-internacional-de-birmingham/':
                        ...
                        europa.append('Birmingham')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-internacional-de-bristol/':
                        nodes.append('Bristol')
                        europa.append('Bristol')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-internacional-de-liverpool/':
                        nodes.append('Liverpool')
                        europa.append('Liverpool')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-manchester/':
                        nodes.append('Manchester')
                        europa.append('Manchester')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-internacional-de-newcastle/':
                        nodes.append('Newcastle')
                        europa.append('Newcastle')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-gibraltar/':
                        nodes.append('Gibraltar')
                        europa.append('Gibraltar')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-internacional-owen-roberts/':
                        nodes.append('GeorgeTown')
                        europa.append('GeorgeTown')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-praga/':
                        nodes.append('Prague')
                        europa.append('Prague')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-internacional-de-bucarest-henri-coanda/':
                        nodes.append('Bucarest')
                        europa.append('Bucarest')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-estocolmo-arlanda/':
                        nodes.append('Stockholm')
                        europa.append('Stockholm')
                    ...
                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-zurich/':
                        nodes.append('Zurich')
                        europa.append('Zurich')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-internacional-de-ginebra/':
                        nodes.append('Ginebra')
                        europa.append('Ginebra')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-internacional-ataturk/':
                        nodes.append('Istanbul')
                        europa.append('Istanbul')
        ...
        try:
            ...
            if row[1] == 'salida':
                if row[0] != 'aeropuerto':
                    ...
                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-verona-villafranca/':
                        nodes.append('Verona')
                        europa.append('Verona')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-venecia/':
                         nodes.append('Venice')
                         europa.append('Venice')
                    ...
                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-catania-fontanarossa/':
                        nodes.append('Catania')
                        europa.append('Catania')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-palermo-punta-raisi/':
                        nodes.append('Palermo')
                        europa.append('Palermo')
                    ...
                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-bolonia/':
                        nodes.append('Bologna')
                        europa.append('Bologna')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-rimini/':
                        nodes.append('Miramare')
                        europa.append('Miramare')
                    ...
                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-florencia/':
                        nodes.append('Florence')
                        europa.append('Florence')


                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-reggio-di-calabria/':
                        nodes.append('ReggioCalabria')
                        europa.append('ReggioCalabria')
                    ...
                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-brescia/':
                        nodes.append('Montichiari')
                        europa.append('Montichiari')


                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-bergamo-orio-al-serio/':
                        nodes.append('Bergamo')
                        europa.append('Bergamo')


                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-cagliari-elmas/':
                        nodes.append('Cagliari')
                        europa.append('Cagliari')


                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-alghero-fertilia/':
                        nodes.append('Alghero')
                        europa.append('Alghero')

                    if row[0] == 'https://www.aeropuertos.net/aeropuerto-de-ancona-falconara/':
                        nodes.append('Ancona')
                        europa.append('Ancona')
